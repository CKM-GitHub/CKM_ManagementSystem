...
namespace CKM_ManagementSystem.BL
{
    public class MainMenuBL
    {
        ...
        public async Task<List<MainMenuViewModel>> GetMainMenus(string staffCode)
        {
            ...
            DataTable dataTable = await _baseDL.SelectDataTableAsync("Menu_GetMainMenu", parameters);
