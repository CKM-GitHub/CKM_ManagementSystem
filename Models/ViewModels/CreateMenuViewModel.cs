...
namespace CKM_ManagementSystem.Models.ViewModels
{
    public class CreateMenuViewModel
    {
        ...
        [RegularExpression(@"^[a-zA-Z]+$", ErrorMessage = "Action Name can only contain letters and spaces.")]
        ...
        [RegularExpression(@"^\d{1,3}$", ErrorMessage = "Display Order must be Maximum 3 digits.")]
