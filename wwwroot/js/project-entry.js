...
$(document).ready(function () {
    ...
    $('#ProjectCode').on(
        ...
        function () {
            ...
            $.post(
                '/Project/CheckDuplicateProjectCode',
                {
                    projectCode: val
                },
                function (res) {
    ...
    $('#ProjectName').on(
        ...
        function () {
            ...
            $.post(
                '/Project/CheckDuplicateProjectName',
                {
                    projectName: val,
                    projectCode: codeVal,
                    isEdit: isEditMode
    ...
    function updateRowNumbers() {
        $('#tblSelectedMembers tbody tr[data-staffcode]')
            .each(
                function (index) {
                    $(this)
                        .find('.row-no')
                                ...
                                var row = `
                                    <tr>
                                        <td class="text-center">
                                            <input
                                                type="checkbox"
                                                class="form-check-input chk-member"
                                                value="${staffCode}"
                                                data-name="${name}"
                                                data-img="${img}"
            ...
            selected.each(function () {
                ...
                var row = `
                    <tr
                        ...
                        <td class="text-center text-muted row-no">
                        </td>
